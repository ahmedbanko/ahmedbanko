  ...
  return (
    <li className="container mx-auto">
      <div className="flex flex-wrap justify-between md:space-x-10">
        ...
        {project.sourceCode ? (
          <button className="flex min-w-32 max-h-8 min-h-6 text-xs items-center bg-stone-300 text-gray-950 rounded-full px-4 py-2 hover:bg-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-600"
        ...
        project.url ? (
          <button className="flex justify-center min-w-32 max-h-8 min-h-6 text-xs bg-stone-300 dark:bg-gray-800 text-gray-950 rounded-full py-2 dark:text-white" disabled>
